...
export const SNIPPETS: Snippet[] = [
  ...
  { trigger: "arrow_left", description: "Insert a left arrow", expand: () => "←" },
  { trigger: "arrow_right", description: "Insert a right arrow", expand: () => "→" },
  { trigger: "arrow_up", description: "Insert an up arrow", expand: () => "↑" },
  { trigger: "arrow_down", description: "Insert a down arrow", expand: () => "↓" },
